...
public class DbConnectorTest {
    ...
    static void setUp() {
        try {
            ...
            storeFile = new File("testFiles/store.txt");
            ...
            album1File = new File("testFiles/19_Adele.txt");
            ...
            album2File = new File("testFiles/Coat of Many Colors_Dolly Parton.txt");
            ...
            album3File = new File("testFiles/Sigh No More_Mumford & Sons.txt");
            ...
            album4File = new File("testFiles/Sons_The Heavy.txt");
            ...
            album5File = new File("testFiles/Mission Bell_Amos Lee.txt");
            ...
            album6File = new File("testFiles/Tapestry_Carol King.txt");
            ...
            ms = new MusicStore();
            try {
                ms.readFile(storeFile.getAbsolutePath());
            } catch (IOException e) {
                fail();
            }
    ...
    public void testCtorJsonFileDoesntExist() {
        ...
        assertDoesNotThrow(() -> dbc = new DbConnector(ms, dbFile.getAbsolutePath()));
    }
}
